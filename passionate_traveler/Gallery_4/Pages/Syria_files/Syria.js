...
{return IWCreatePhotocast("http://www.passionate-traveler.com/passionate_traveler/Gallery_4/Pages/Syria_files/rss.xml",false);}
...
{var registry=IWCreateEffectRegistry();registry.registerEffects({stroke_0:new IWStrokeParts([{rect:new IWRect(-1,1,2,46),url:'Syria_files/stroke.png'},{rect:new IWRect(-1,-1,2,2),url:'Syria_files/stroke_1.png'},{rect:new IWRect(1,-1,57,2),url:'Syria_files/stroke_2.png'},{rect:new IWRect(58,-1,2,2),url:'Syria_files/stroke_3.png'},{rect:new IWRect(58,1,2,46),url:'Syria_files/stroke_4.png'},{rect:new IWRect(58,47,2,2),url:'Syria_files/stroke_5.png'},{rect:new IWRect(1,47,57,2),url:'Syria_files/stroke_6.png'},{rect:new IWRect(-1,47,2,2),url:'Syria_files/stroke_7.png'}],new IWSize(59,48)),shadow_0:new IWShadow({blurRadius:9,offset:new IWPoint(4.2426,4.2426),color:'#000000',opacity:1.000000})});registry.applyEffects();}
function hostedOnDM()
{return false;}
function onPageLoad()
{IWRegisterNamedImage('comment overlay','../../Media/Photo-Overlay-Comment.png')
IWRegisterNamedImage('movie overlay','../../Media/Photo-Overlay-Movie.png')
loadMozillaCSS('Syria_files/SyriaMoz.css')
